...
def split_sequence(sequence1,sequence2, sliding_window_width,sw_len):
    X, Y = [], []
    # print('Data1的shape:{},序列长度:{}'.format(sequence1.shape,len(sequence1)))
    # print('Data2的shape:{},序列长度:{}'.format(sequence2.shape,len(sequence1)))
    for i in range(len(sequence1)): #78
