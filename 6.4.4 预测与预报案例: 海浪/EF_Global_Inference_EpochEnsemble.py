...
def data_preprocess(dataset_name = "southocean_2022"):
  ...
  #  print(data)
    ...
    # # 构造 0.5° 全球经纬度
    # # ==============================
    # lon = np.arange(0, 360, 0.5)          # (720,)
    # lat = np.arange(70, -70.5, -0.5)      # (361,)
    ...
    # # ==============================
    # # u10, v10 单位一般是 m/s
    # wind_u = np.random.randn(365, nlat, nlon) * 5    # 模拟 -10~10 m/s
    # wind_v = np.random.randn(365, nlat, nlon) * 5

    # # 有效波高 swh，一般是正值（米）
    # wave_height = np.abs(np.random.randn(365, nlat, nlon)) * 2  # 0~6 m 左右

    # print("lon shape:", lon.shape)
    # print("lat shape:", lat.shape)
    # print("wind_u shape:", wind_u.shape)
    # print("wind_v shape:", wind_v.shape)
    # print("wave_height shape:", wave_height.shape)
...
def NetInference():
    ...
    model_names = ['latest_checkpoint.pt']  
    ...
    for model_name in model_names:
        ...
        if torch.cuda.is_available():
            ...
            # 加载检查点
        checkpoint = torch.load("/mnt/nvme1/1216/AI-Wave-Height-Model-main/global_ocean/model/"+model_name,weights_only=False)
